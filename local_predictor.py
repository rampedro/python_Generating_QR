...
#%% split training set to validation set
	...
	## OLD DATASET
	# 160 kg , 140 cm , non smoker 	HEALTHY

	# 161 kg , 140 cm , smoker 	Not healthy
	# 161 kg , 140 cm , smoker 	Not healthy
	# 161 kg , 140 cm , smoker 	Not healthy
	# 161 kg , 140 cm , smoker 	Not healthy

	
	# 160 kg , 140 cm , smoker 	HEALTHY


	## input = new user1 data + OLD DATASET + run on top of already trained configuration.  machine = healthy or not(+ BMI, blog pressure) 
	## new user1 data + OLD DATASET + run on top of already trained configuration.
	## new user1 data + OLD DATASET + run on top of already trained configuration.
	## new user1 data + OLD DATASET + run on top of already trained configuration.
	## new user1 data + OLD DATASET + run on top of already trained configuration.
	## new user1 data + OLD DATASET + run on top of already trained configuration.
